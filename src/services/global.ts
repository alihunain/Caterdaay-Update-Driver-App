...
export const imageUrlupload: string = 'https://www.caterdaay.com:4024/upload';
export const imageUrl: string = 'https://www.caterdaay.com:4024/uploads/';
export const imageUrl2: string = 'https://www.caterdaay.com:4004/uploads/';
export const url2: string = 'https://www.caterdaay.com:4004/';
export const url1: string = 'https://www.caterdaay.com:4014/';

export const url4: string = 'https://www.caterdaay.com:4034/';
export const url3: string = 'https://www.caterdaay.com:4044/';
