...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_one_service__ = __webpack_require__(53);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.afterDriverGet = function (driver) {
        var driverobj = driver;
        console.log(driverobj, "check it ");
        var that = this;
        FCMPlugin.getToken(function (token) {
            console.log(token);
            that.AddTokenToDB(token, driverobj);
            console.log(token);
        });
    };
    LoginPage.prototype.AddTokenToDB = function (token, that) {
        ...
        this.oneService.editDriver(data).subscribe(function (res) {
            console.log(res);
        });
    };
    ...
    LoginPage.prototype.doLogin = function () {
        ...
        loading.present();
        this.oneService.login(this.loginForm.value).subscribe(function (response) {
            loading.dismiss();
            if (!response.error) {
                localStorage.setItem("driver", JSON.stringify(response.data));
                _this.driver = response.data;
                _this.afterDriverGet(response.data);
...
var OneService = /** @class */ (function () {
    ...
    OneService.prototype.Getowner = function (id) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_2__global__["b" /* url1 */] + 'owners/' + id).map(function (response) {
            var ower = response.json();
            return ower;
        });
    };
    OneService.prototype.Notification = function (data) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_2__global__["b" /* url1 */] + "notifications", data).map(function (response) {
            var ower = response.json();
            return ower;
        });
    };
    ...
    OneService.prototype.EmailDriverAccepted = function (data) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_2__global__["b" /* url1 */] + "order-email-driveraccepted", data).map(function (response) { return response.json(); });
    };
    OneService.prototype.EmailOntheway = function (data) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_2__global__["b" /* url1 */] + "order-email-driveronway", data).map(function (response) { return response.json(); });
    };
    OneService.prototype.EmailDelivery = function (data) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_2__global__["b" /* url1 */] + "order-email-delivered", data).map(function (response) { return response.json(); });
    };
    ...
    OneService.prototype.updateCustomer = function (data) {
        return this.http.put(__WEBPACK_IMPORTED_MODULE_2__global__["e" /* url4 */] + 'customers/' + data._id, data)
            .map(function (response) { return response.json(); });
    };
    OneService.prototype.editOwner = function (data) {
        return this.http.put(__WEBPACK_IMPORTED_MODULE_2__global__["b" /* url1 */] + 'owners/' + data._id, data)
            .map(function (response) { return response.json(); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_one_service__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_global__ = __webpack_require__(63);
...
var ProfileEditPage = /** @class */ (function () {
    ...
    ProfileEditPage.prototype.Checker = function () {
    };
    ...
    ProfileEditPage.prototype.profileUpdate = function () {
        // console.log(this.editForm.get('_id').valid,"_id");
        // console.log(this.editForm.get('license').valid,"license");
        // console.log(this.editForm.get('address').valid,"address");
        // console.log(this.editForm.get('image').valid,"image");
        // console.log(this.editForm.get('vehicleNo').valid,"vehicleNo");
        // console.log(this.editForm.get('vehicleName').valid,"vehicleName");
        // console.log(this.editForm.get('phoneNo').valid,"phoneNo");
        // console.log(this.editForm.get('vehicleType').valid,"vehicleType");
        // console.log(this.editForm.get('email').valid,"email");
        // console.log(this.editForm.get('lastname').valid,"lastname");
        // console.log(this.editForm.get('firstname').valid,"firstname");
        // console.log(this.editForm.get('zip').valid,"zip");
        // console.log(this.editForm.get('isactivated').valid,"isactivated");
        // console.log(this.editForm.get('ByBank').valid,"ByBank");
        // console.log(this.editForm.get('ByCheque').valid,"ByCheque");
        // console.log(this.editForm.get('carnumberplate').valid,"carnumberplate");
        // console.log(this.editForm.get('carinsurance').valid,"carinsurance");
        // console.log(this.editForm.get('policecertificate').valid,"policecertificate");
        // console.log(this.editForm.get('BankName').valid,"BankName");
        // console.log(this.editForm.get('paymentmethod').valid,"paymentmethod");
        // console.log(this.editForm.get('AccountNumber').valid,"AccountNumber");
        // console.log(this.editForm.get('AccountName').valid,"AccountName");
        // console.log(this.editForm.get('voidcheque').valid,"voidcheque");
        // return;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_one_service__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_one_service__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_two_service__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_global__ = __webpack_require__(63);
...
var TermsOfUse = /** @class */ (function () {
    ...
    TermsOfUse = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-term',template:/*ion-inline-start:"D:\Apps\CaterdaayDriverApp\src\pages\signup\termofuse.html"*/'\n\n<!-- \n\n<ion-header>\n\n    <ion-navbar color="secondary">\n\n        <button ion-button style="background-color:#449d44 !important; box-shadow: none !important;" >\n\n            <ion-icon style="font-size:22px;padding-left: 5px;padding-right: 21px" name="arrow-round-back" (click)="viewDismiss()"></ion-icon>\n\n            <ion-title >Terms of Use</ion-title>\n\n        </button>\n\n       \n\n    </ion-navbar>\n\n     \n\n</ion-header> -->\n\n<ion-header>\n\n    <!-- <ion-navbar color="secondary">\n\n            \n\n        <ion-title><strong><ion-icon name="arrow-round-back" (click)="viewDismiss()" style="font-size:22px;padding-left: 5px;padding-right: 21px"></ion-icon></strong><span></span>Terms of Use</ion-title>\n\n    </ion-navbar> -->\n\n    <ion-navbar color="secondary"> \n\n        <ion-buttons end>\n\n        <button ion-button  left  icon-only (click)="viewDismiss()">\n\n                <ion-icon name="close-circle"></ion-icon>\n\n        </button>\n\n    </ion-buttons>\n\n        <ion-title text-center>Terms of Use </ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content >\n\n<div style="background: white; padding: 15px;">\n\n<h2 >      Agreement with Terms</h2>      \n\n<p>\n\nBy using this website or mobile application or working with our employees or agents by any means (including telephone, text, email, chat, in-person, or any other mechanism), you accept our Agreement. We reserve the right to make changes to our websites, our mobile applications, our services, and the Agreement at any time. Your use of our services or working with our employees or agents after any changes have been made constitutes acceptance of the changes.\n\nThis website, mobile application, compilation, content and software may only be used as a personal e-commerce resource. Any other use, including the reproduction, modification, distribution, transmission, republication, display, sale, resale, unauthorized use, or other exploitation of any part of the website, mobile application, compilation, content and software without express prior written permission from Caterdaay is strictly prohibited, may violate copyright, trademark and other laws, and may result in your being responsible for any and all associated damages. The application or linking of this website, mobile application, compilation, content or software into any other website, mobile application, compilation, content or software without express prior written permission from Caterdaay is also strictly prohibited.\n\nCaterdaay.com, the Caterdaay logo, and certain other product or service names referenced are trade or service marks of Caterdaay. Certain product, company, trade, and service names referenced are trade or service marks of their respective owners. None of these marks may be used in connection with any product or service different from that correctly associated with the mark, in any manner that disparages or discredits the mark\'s owner, or in any manner that is likely to cause confusion.\n\nCaterdaay and our affiliates and partners reserve the right to refuse service, terminate accounts, and/or modify or cancel orders at our discretion, for any cause or without cause.\n\n\n\n</p>\n\n<h2 >      Caterdaay Accounts</h2>      \n\n<div>\n\n<ul>\n\n    <li>a.	All information provided by you on the Caterdaay Platform (to create an account for use of the Caterdaay Platform or in connection with your use of the Caterdaay Services is true, accurate, current and complete. </li>\n\n    <li>b.	You agree that Any Caterdaay Account you create must be kept secure and will not be shared or disclose the Caterdaay Account credentials with anyone. No members of the Caterdaay Group will be liable for any loss or damage arising from your failure to safeguarding your Caterdaay Account, use a strong password or limit its use to your Caterdaay Account. </li>\n\n    <li>c.	Caterdaay reserves the right to deny your request for a Caterdaay Account (including usernames) and to disable or terminate access to any Caterdaay Account (including usernames) issued to you at any time in Caterdaay’s sole discretion. If Caterdaay disables access to a Caterdaay Account issued to you, you will be prevented from accessing the Caterdaay Platform or the Caterdaay Services, your Caterdaay Account details, Orders or other information that is associated with your Caterdaay Account. </li>\n\n    <li>d.	Caterdaay may suspend or terminate your ability to access the Caterdaay Platform, or cease providing you with all or part of the Caterdaay Services at any time for any or no reason. You acknowledge and agree that all suspensions or terminations may be made by Caterdaay in its sole discretion and that no members of the Caterdaay Group will be liable to you or any third-party for any suspension or termination of your access or for the removal of any of the materials uploaded by you to the Caterdaay Platform. Any suspension or termination of this Agreement by Caterdaay will be in addition to any and all other rights and remedies that Caterdaay may have. </li>\n\n    <li>deleted, we may disable your Caterdaay customer account for fraud prevention or other lawful purposes. We may terminate these Terms of Service at any time by giving notice to you, at our discretion, by email at your current email address on file with us or through the Caterdaay Platform. </li>\n\n</ul>\n\n</div>\n\n<h2 >      Ownership of Certain Information</h2>      \n\n<p>\n\nIf you post names of, reviews of, or comments on products or companies on Caterdaay\'s websites or mobile applications, you grant Caterdaay and our affiliates and partners a non-exclusive, royalty-free, and fully sub-licensable right to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display such names, reviews, and comments throughout the world in any media. You also grant Caterdaay and our affiliates and partners the right to use the name (if any) that you submit with any name, review, or comment in connection with such name, review, or comment.\n\n</p>\n\n<p>\n\nIf you allow us to post your menu, pricing, logo, photographs or other images, delivery terms or delivery requirements, or any other information on our websites or mobile applications, you grant Caterdaay and our affiliates and partners a non-exclusive, royalty-free, perpetual, irrevocable, and fully sub-licensable right to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display such menu, pricing, logo, delivery requirements, or other information throughout the world in any media, subject to our usage of your trade or service marks as specified elsewhere in these Terms.\n\n</p>\n\n<h2 >      Risk of Loss; Guarantee</h2>      \n\n<p>\n\nAll items purchased through Caterdaay are made pursuant to a fulfillment agreement with one or more third parties (such as food providers or delivery companies). Should there be errors, Caterdaay will offer every reasonable assistance in the correction of that error. In any event, however, the risk of loss and title for such items pass to you upon our conveyance of your order to the third party/ies. It may be necessary for you to file claims with those parties.\n\n</p>\n\n<h2 >      Indemnification</h2>      \n\n<p>\n\nYou, your employer (if any), and any individual or company (if any) for whom you are a contractor, agree to indemnify and hold Caterdaay, our subsidiaries, affiliates, officers, agents, and other partners and employees harmless from any loss, liability, damage, claim, or demand, including reasonable attorneys\' fees, made by any party due to or arising out of (a) your use of this website or mobile application or any Caterdaay services in any way, (b) your fulfillment or attempted fulfillment of any orders sent to you or facilitated by Caterdaay, (c) your delivery or attempted delivery of any orders sent to you or facilitated by Caterdaay, whether sent to you directly or indirectly by Caterdaay, or (d) any other engagement or attempted engagement with Caterdaay.\n\n</p>\n\n<p>\n\nCaterdaay reserves the right to limit purchases and purchase quantities. In the event of any error, you may be limited to a single unit purchase. Pricing on this website or mobile application is subject to change without notice.\n\n</p>\n\n<h2 >      No Agency Relationship</h2>      \n\n<p>\n\nYou agree that Caterdaay is not responsible for any information you convey, in any manner, and that we have no control over any actions you take or statements you make. You agree that you and Caterdaay are independent contractors, and that neither you nor we are in any way an agent for the other party.\n\n</p>\n\n<h2 >      ORDERING TERMS</h2>      \n\n<p>\n\nFor clarity of services, Caterdaay does not prepare or fulfil any orders for Goods or provide delivery services directly and no members of the Caterdaay Group will be liable for any transactions between Customers, Couriers or Chefs/Vendors. Menus and other Chefs/Vendor-related information on the Caterdaay Platform is content provided by the Chefs/Vendor and not Caterdaay. \n\n</p>\n\n<div>\n\n<ul>\n\n    <li>a.	It is required to create user account to use the Caterdaay Platform and services. Once you have created your Caterdaay Customer Account you may select Goods from a Caters/Vendor’s menu, choose your desired quantities, and then add them to your cart and if you wish you may proceed to place your Order, provide your payment card information or select the cash payment option, if available, and an Order will be created and sent to the Vendor. You are responsible to ensure that all of your Order details, including billing, delivery address and other information is current, complete and accurate. </li>\n\n    <li>b.	The Caters/ Vendors will confirm all Orders and to communicate any inability or unwillingness to confirm promptly. We will notify you as soon as reasonably practicable if the Vendor does not confirm your Order. Vendor\'s may have the discretion to not confirm Orders. You agree that Caterdaay or the Vendor will have no liability to you for Orders that are not confirmed, are cancelled or that the Vendor has been unable or unwilling to fulfill. </li>\n\n    <li>c.	The legal contract for the purchase of Goods will in all cases be between the Customer and the Caters/Vendor. Caterdaay act as your sole and exclusive agent for the purpose of concluding contracts for the sale of Goods between you and the Chefs/Vendor by means of you placing Orders via the Caterdaay Platform. YOU ACKNOWLEDGE AND AGREE THAT NO MEMBER OF THE Caterdaay GROUP HAS ANY CONTROL OVER THE QUALITY OF THE GOODS OR SERVICES OFFERED BY VENDORS AND COURIERS AND THAT NO MEMBERS OF THE Caterdaay GROUP WILL HAVE LIABILITY TO YOU FOR ANY PROBLEMS CAUSED BY THE VENDOR CONCERNING YOUR ORDERS, INCLUDING, WITHOUT LIMITATION, MISSED OR LATE DELIVERIES, MISSED GOODS ITEMS, AND ANY PROBLEMS WITH RESPECT TO THE QUALITY OF THE GOODS DELIVERED INCLUDING IF GOODS CAUSE ILLNESS, ALLERGIC REACTIONS OR HAVE INCORRECT NUTRITIONAL VALUES. NO RESPONSIBILITY FOR VENDORS AND COURIERS. Chefs/VENDORS AND COURIERS OFFERING GOODS OR SERVICES THROUGH THE Caterdaay PLATFORM ARE INDEPENDENT PERSONS OR ORGANIZATIONS AND NOT REPRESENTATIVES, AGENTS OR EMPLOYEES OF Caterdaay. Caterdaay IS THEREFORE NOT LIABLE FOR THE ACTS, ERRORS, OMISSIONS, REPRESENTATIONS, WARRANTIES, CONTRACTUAL BREACHES OR NEGLIGENCE OF ANY Chefs/VENDORS OR COURIERS OR FOR ANY PERSONAL INJURY, DEATH, PROPERTY DAMAGE, OR OTHER DAMAGES OR EXPENSES RESULTING THEREFROM AND TAKES NO RESPONSIBILITY WHATSOEVER FOR THE PRODUCTS OR SERVICES OFFERED BY Chefs/VENDORS OR COURIERS. CHEFS/VENDORS ARE REQUIRED/RESPONSIBLE TO UPLOAD VALID/LEGAL/PAID IMAGES ON THEIR MENU/COMBO/Weekly PACKAGES.</li>\n\n    <li>d.	For Delivery Orders that the Vendor arranges or for which third party couriers provide delivery services, we are not liable for any service or product provided by such couriers.</li>\n\n</ul>\n\n</div>    \n\n<!-- </p> -->\n\n<h2 >      Pickup or Delivery </h2>      \n\n<p>\n\nCustomer has an option to pick up or get it delivered by courier at the premise of the Chefs/Vendor ("Pickup Order") or delivered to you by a third-party courier or courier of the Chefs/Vendor ("Delivery Order"). You may be provided a time for when the Pickup Order will be ready for pickup or when the Delivery Order will be delivered. These times are only an estimate and Caterdaay and the Chefs/Vendor offer no guarantee that these times will be achieved. Caterdaay is not responsible for any delays in receiving or having your Order ready for any reason. For a Pickup Order, you will arrive at the time provided and Caterdaay and the Chefs/Vendor are under no obligation to remake or refund the Goods if you do not arrive when indicated.  \n\n</p>\n\n<h2 >      CANCELLATIONS</h2>      \n\n<p>\n\nCustomer can cancel an order up to 10 minutes from placing the order on our website or mobile apps. Caterdaay make every effort to ensure that accurate pricing and descriptions are maintained, we reserve the right to cancel any order that is based on inaccurate information. Caterdaay.com and our partner Chefs reserve the right to cancel any order, before or after acceptance, and will notify you immediately of any such cancellation.   \n\n</p>\n\n<h2 >      REFUNDS</h2>      \n\n<p>\n\nPlease contact Caterdaay.com through our live chat or call us on our hotline number, regarding the issue of your food order.  In case if you have already been billed by Caterdaay.com, we will issue full or partial refunds in the following cases: if you did not receive your order or received an incorrect order, you may be issued a full refund; if part of your order is missing, we may issue a partial refund. In every event, we will do our best to ensure your satisfaction.\n\n</p>\n\n<h2 >      Pricing and Payment</h2>      \n\n<p>\n\nThe user/customer is hereby agreeing to pay in full the prices (including, without limitation, all applicable taxes) for any orders placed using your User Account(s) (or any orders placed as a guest). \n\n</p>\n\n<p>\n\nThe user/customer are responsible for any taxes imposed on any transactions conducted on or in connection with this Site and applicable taxes will be added to the amount charged for the applicable transaction on this Site.  \n\n</p>\n\n<p>\n\nYour use of this Site includes the ability to enter into agreements and/or to make purchases electronically. You acknowledge that your electronic submissions constitute your agreement and intent to be bound by and to pay for such agreements and purchases. Your agreement and intent to be bound by electronic submissions applies to all records relating to all transactions you enter into on this Site, including without limitation and to the full extent allowed by law, notices of cancellation, policies, contracts, and applications \n\n</p>\n\n\n\n<h2 >      Limitation of Liability</h2>      \n\n<p>\n\nCaterdaay.com will not be liable for any damages or injuries caused by, including but not limited to, any failure of performance, error, omission, interruption, defect, delay in operation of transmission, computer virus, or line failure. Under no circumstances shall Caterdaay be liable for any damages resulting from the use of this Site or the Materials, including without limitation, indirect, special, consequential, incidental or punitive losses, damages or expenses or lost profits or savings even if Caterdaay has been advised of their possible existence, or even if Caterdaay or an authorized Caterdaay representative has been advised of the possibility of such damages, or both.  \n\n</p>\n\n<h2 >      Personal Information</h2>      \n\n<p>\n\nWe respect your privacy and the use and protection of your personally identifiable information. During your use of this Site, you may be asked to provide certain personalized information to us (such information referred to hereinafter as “Personal Information”). Our information collection and use policies with respect to the privacy of such Personal Information are set forth in this Site’s Privacy Policies, which is incorporated herein by reference for all purposes. We encourage you to read the Privacy Policies, and to use it to help make informed decisions. You acknowledge and agree that you are solely responsible for the accuracy and content of Personal Information.  \n\n</p>\n\n<h2 >      Rescheduling Policy</h2>      \n\n<p>\n\nCustomer can re-schedule, Chef has to accept the new date.\n\n</p>\n\n<h2 >      \n\nDelivery Charges & Policy\n\n</h2>      \n\n<p>\n\nFor All delivery options (Both Chef and customer has to be in the same City). Any delivery outside the Chef\'s city will be charged based on the KMs. For weekly and monthly meal plans Half of your order will be delivered on Sunday morning/afternoon based on your selected time schedule and the remaining half will be delivered on Wednesday on your selected time. There is a discounted flat rate apply. \n\n</p>\n\n<p>\n\n<strong> Daily scheduled Delivery: </strong> Customer will receive the order every day. Caterdaay.com will charge a flat fee per order\n\n</p>\n\n<p>\n\n<strong> Delivery with 45-60 mins: </strong> If you order food item for instant delivery, then it will be at your door step within 45- min for the rate determined by the distance (KM). \n\n</p>\n\n<p>\n\n<strong>Note: </strong> For apartment or condo residents, please also make sure that your concierge accepts food deliveries and notifies you on arrival. The delivery may get delayed due to weather conditions and traffic accidents, road closures, or city events. Please bear with us if your order is not delivered within the delivery window as we are trying to get your order to you as quickly as possible!\n\n</p>\n\n<p>\n\nCaterdaay accepts orders until Friday noon. The orders will be delivered on Sunday and Wednesday for weekly/monthly subscription as follow:\n\n</p>\n\n<div>\n\n<h4>Sunday Deliveries</h4>\n\n<p> 9:30:00 AM – 2:30 AM</p>\n\n<h4>Wednesday Deliveries</h4>\n\n<p> 11:30 AM - 2:30 PM</p>\n\n<p>6:30 PM - 10:30 PM</p>\n\n</div>\n\n</div>\n\n</ion-content>'/*ion-inline-end:"D:\Apps\CaterdaayDriverApp\src\pages\signup\termofuse.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global__ = __webpack_require__(63);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__one_service__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_one_service__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26_angularfire2__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_one_service__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_order_order__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_profile_profile__ = __webpack_require__(544);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_login_login__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_restaurants_restaurants__ = __webpack_require__(551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_location_service__ = __webpack_require__(638);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_three_service__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_badge__ = __webpack_require__(641);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_network__ = __webpack_require__(642);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_angularfire2_database__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_firebase__ = __webpack_require__(139);
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, events, locationTracker, alertCtrl, toastCtrl, loadingCtrl, statusBar, splashScreen, threeService, app, badge, afd, oneService, 
        ...
        this.firestore = __WEBPACK_IMPORTED_MODULE_14_firebase___default.a.database().ref('/drivers');
        ...
        this.initializeApp();
        this.pages = [
            { title: 'Profile', component: __WEBPACK_IMPORTED_MODULE_6__pages_profile_profile__["c" /* ProfilePage */] },
            { title: 'Orders', component: __WEBPACK_IMPORTED_MODULE_5__pages_order_order__["b" /* OrderPage */] },
            { title: 'Caters', component: __WEBPACK_IMPORTED_MODULE_8__pages_restaurants_restaurants__["a" /* RestaurantsPage */] },
        ...
        setTimeout(function () {
            if (localStorage.getItem('driver')) {
                if (_this.currentComponentPage == 'RestaurantsPage') {
                    _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_8__pages_restaurants_restaurants__["a" /* RestaurantsPage */]);
                }
                else if (_this.currentComponentPage == 'ProfilePage') {
                    _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_6__pages_profile_profile__["c" /* ProfilePage */]);
                }
                else if (_this.currentComponentPage == 'OrderPage') {
                    _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages_order_order__["b" /* OrderPage */]);
                }
                else {
                    _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages_order_order__["b" /* OrderPage */]);
                }
    ...
    MyApp.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (localStorage.getItem('driver')) {
                _this.rootPage = __WEBPACK_IMPORTED_MODULE_5__pages_order_order__["b" /* OrderPage */];
                setTimeout(function () {
            ...
            if (typeof FCMPlugin != 'undefined') {
                FCMPlugin.onNotification(function (data) {
                    // if(JSON.parse(localStorage.getItem("driver")) == undefined){
                    //   return;
                    // }
                    // if(JSON.parse(localStorage.getItem("driver"))._id != data._id){
                    //   return;
                    // }
                    console.log(data);
                    if (typeof cordova != 'undefined') {
        ...
        var prompt = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'oK',
                    handler: function (data) {
                        _this.updateTokenDB().then(function (token) {
                            _this.oneService.editDriver(token).subscribe(function () {
                                localStorage.removeItem('driver');
                                _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_7__pages_login_login__["a" /* LoginPage */]);
                                _this.getCurrentPage();
                            });
    ...
    MyApp.prototype.updateTokenDB = function () {
        var that = this;
        return new Promise(function (resolve, reject) {
            FCMPlugin.getToken(function (token) {
                var t = token;
                var id = JSON.parse(localStorage.getItem("driver"))._id;
                that.oneService.getDriver(id).subscribe(function (res) {
    ...
    MyApp.prototype.getOrder = function (id) {
        ...
        this.threeService.getOrderById(id).subscribe(function (data) {
            if (!data.error) {
                _this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages_order_order__["a" /* OrderDetailPage */], {
    ...
    MyApp = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__services_three_service__["a" /* ThreeService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_global__ = __webpack_require__(63);
...
var OrderPage = /** @class */ (function () {
    ...
    OrderPage.prototype.openDetail = function (index, type) {
        if (type == 'pending') {
            console.log(this.pendorders[index]);
...
var OrderDetailPage = /** @class */ (function () {
    ...
    OrderDetailPage.prototype.CheckMinimumDelivery = function (deliverytime) {
        ...
        newdeliver.subtract({ hours: 1, minutes: 1 });
    ...
    OrderDetailPage.prototype.Notification = function (order, status) {
        var _this = this;
        var token = [];
        this.oneService.Getowner(order.restaurantData.ownerId).subscribe(function (res) {
            token = res.message.fcmToken;
            var data = {
                type: "driver", status: status, tokenscustomer: order.customerData.fcmToken, tokenschef: token, orderId: order._id,
                userid: order.customerData._id, chefid: order.restaurantData.ownerId
            };
            var userid = order.customerData._id;
            var ownerid = order.restaurantData.ownerId;
            _this.oneService.Notification(data).subscribe(function (res) {
                var data2 = { _id: userid, fcmToken: res.message.usertoken };
                var data3 = { _id: ownerid, fcmToken: res.message.ownertoken };
                _this.oneService.updateCustomer(data2).subscribe(function () {
                    _this.oneService.editOwner(data3).subscribe(function () {
                    });
                });
            });
        });
    ...
    OrderDetailPage.prototype.ComboOnStatus = function (status, orderid) {
        ...
        if (status == 'driveraccepted') {
            ...
            question = 'have you delivered the order?';
        }
        var prompt = this.alertCtrl.create({
            message: question,
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        console.log("I Reached out");
                        if (status == 'driveraccepted') {
                            console.log("I Reached in");
                            ...
                            _this.Notification(_this.orderDetail, "accepted");
                            _this.oneService.getDriver(_this.driver._id).subscribe(function (data) {
                                console.log(data, "updated driver");
                            });
                            var obj1 = { customeremail: _this.orderDetail.customerData.email, order: _this.orderDetail };
                            console.log("I Reached 1");
                            _this.oneService.EmailDriverAccepted(obj1).subscribe(function () {
                                console.log("Email Done");
                            });
                            _this.orderDetail.driverDetail = _this.driver;
                        }
                        else if (status == "ontheway") {
                            _this.Notification(_this.orderDetail, "ontheway");
                            var obj1 = { customeremail: _this.orderDetail.customerData.email, order: _this.orderDetail };
                            _this.oneService.EmailOntheway(obj1).subscribe(function () {
                                console.log("Email Done");
                            });
                        }
                        else if (status == "delivered") {
                            _this.Notification(_this.orderDetail, "delivered");
                            var obj1 = { customeremail: _this.orderDetail.customerData.email, order: _this.orderDetail };
                            _this.oneService.EmailDelivery(obj1).subscribe(function () {
                                console.log("Email Done");
                            });
                        }
